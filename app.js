...
const TUTORIAL_STEPS = [
  {
    target: '.logo-area',
    title: '歡迎使用 EP 報價系統 👋',
    body: '這是放洋留遊學的 EP 語言學校報價工具。本教學將帶你了解完整的報價流程，大約需要 2 分鐘。',
    position: 'right',
  },
  {
  ...
  },
  {
    ...
    body: '先選 EP 語言學校，再選城市校區（倫敦、柏林、巴黎等 10 個）和課程類型。選完後右側會即時顯示費用。',
    position: 'left',
  },
  {
    target: '#step-content',
